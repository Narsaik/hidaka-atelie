    ...
    <>
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-[#fafafa]">
        <div className="container max-w-3xl mx-auto text-center">
          ...
          <p className="text-[#737373] mt-6 max-w-xl mx-auto leading-relaxed">
            Basta enviar uma mensagem no WhatsApp para falar com
      ...
      <section className="section bg-white">
        <div className="container max-w-xl mx-auto">
          ...
          {/* What you receive */}
          <div className="bg-[#fafafa] p-8 mb-10">
            <p className="text-[11px] uppercase tracking-[0.2em] text-[#8b7355] font-medium mb-6">
              Você recebe
            </p>
            <ul className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-8">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 text-[#4a4a4a] hover:text-[#8b7355] transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
