      ...
      <div style={{ borderBottom: '1px solid #333333' }}>
        <div className="container py-10 md:py-14 lg:py-16">
          <div className="max-w-xl mx-auto text-center px-4">
            <p
              className="text-xs uppercase tracking-widest font-medium mb-3 md:mb-4"
            ...
            <p
              className="text-sm mb-6 md:mb-8 leading-relaxed"
              style={{ color: '#a3a3a3' }}
            >
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
            ...
            <div className="md:col-span-3">
              <h3
                className="text-xs uppercase tracking-widest mb-4 md:mb-6"
