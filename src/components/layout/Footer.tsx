      ...
      <div className="container py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5">
            <h2 className="font-serif text-2xl tracking-[0.15em] mb-4">
              HIDAKA
            </h2>
          ...
          <div className="md:col-span-3">
            <h3 className="text-[11px] uppercase tracking-[0.2em] text-[#737373] mb-6">
              Navegação
            </h3>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-[#a3a3a3] hover:text-white transition-colors text-sm flex items-center gap-2"
                >
